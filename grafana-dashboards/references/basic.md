...
- `schemaVersion` - do not hardcode; preserve the value from the source/target export (41 was common for Grafana 11; Grafana 13 dynamic dashboards use the v2 schema — see SKILL.md and `grafana-v2-tabs.md`)
