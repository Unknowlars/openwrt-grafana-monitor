...
def build_dashboard() -> dict[str, Any]:
    ...
    b.add(overview, text(10, "", "## Traffic accounting\nPer-client traffic is keyed directly by MAC from nlbwmon. When software or hardware flow offload is enabled, every nlbwmon traffic panel suppresses its values and the accounting state reports unreliable rather than displaying plausible zeros."), 0, 14, 24, 4)
    ...
    spec: dict[str, Any] = {
        ...
        "description": "Client inventory dashboard for OpenWrt client identity, WiFi association quality, MAC-keyed nlbwmon traffic accounting, and data-quality state.",
