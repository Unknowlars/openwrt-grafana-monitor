...

{
  ...
  printf '# HELP openwrt_wifi_station_connected_seconds WiFi station connected time from iw station dump.\n'
  printf '# TYPE openwrt_wifi_station_connected_seconds gauge\n'
