...
| Router name labels | `openwrt-main`, `openwrt-new` | Label used in Prometheus, Loki, and Grafana |
...
- `openwrt-netflow-v2` needs the optional NetFlow setup below and a ClickHouse
  datasource. Skip it if you are not running NetFlow.
