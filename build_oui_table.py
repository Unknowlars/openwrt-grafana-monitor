...
Usage:
    ...
    python3 build_oui_table.py                     # fetch the registry
    python3 build_oui_table.py --csv path/oui.csv  # use a local copy
...
OUT = Path("openwrt/lua/oui_data.lua")
...
def render(index: str, vendors: list[str], icons: list[str], local_rules) -> str:
    ...
    return f"""-- GENERATED by build_oui_table.py from the IEEE MA-L registry. DO NOT EDIT.
--
-- Regenerate with:  python3 build_oui_table.py
--
...
-- `vendors`. oui.lua binary-searches it. See build_oui_table.py for why this
