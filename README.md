...
The four provisioned dashboards are generated from `build_dashboards.py`. A separate Grafana v2beta1 operations dashboard is generated by `build_openwrt_operations_dashboard.py` into `grafana-dashboard-exports/` for manual import.
...
Router setup accepts `EXPORTER_LISTEN_INTERFACE=lan`, `SYSLOG_PORT=514`, and `SYSLOG_PROTO=udp` if the defaults do not fit your network.
...
│           └── openwrt-logs.json
├── grafana-dashboard-exports/    # Manual-import dashboard exports
