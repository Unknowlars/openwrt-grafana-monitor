...
def build_dashboard() -> dict[str, Any]:
    ...
    b.add(clients, bargauge(102, "Weakest Associated Clients", [prom_query(f'bottomk(10, {WIFI_SIGNAL_BY_MAC} * on(mac) group_left(hostname, ssid, band) openwrt_client_info{{{WIFI_CLIENT_FILTER}}})', "{{hostname}} {{ssid}} {{band}}", "A")], "dBm", "Bottom-10 current WiFi RSSI values. Less negative is better.", thresholds_key="neutral"), 12, 14, 12, 8)
